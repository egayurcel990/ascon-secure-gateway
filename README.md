...
## Patent and Publication Note

If this project is being evaluated for intellectual property filing, avoid publishing detailed patent claims before consulting the university supervisor, LPPM, or an intellectual property office. This repository should be treated as an implementation prototype and demonstration artifact.
